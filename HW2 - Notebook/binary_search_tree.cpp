//This class is taken from lecture slides and there are some modifications.
#include <iostream>
using namespace std;
...
public:
    ...
    void Find_Update(const Comparable& toBeFound, const Comparable& updated);
    bool isEmpty() const;
...
//This function finds and updates the item given in the parameters.
template <class Comparable>
void BinarySearchTree<Comparable>::Find_Update(const Comparable& toBeFound, const Comparable& updated) {
